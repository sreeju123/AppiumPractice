 ...
 * @author Sreej
 */
public class ParallelTestingInBrowserstack {

    @Test
    public void runTestInBS1(Method m) throws MalformedURLException {
...
//                .stream().map(WebElement::getText).forEach(System.out::println);
    ...
    @Test
    public void runTestInBS2(Method m) throws MalformedURLException {
        DesiredCapabilities capabilities = new DesiredCapabilities();
